...
firmware:
	...
	@msp430-gcc --std=c99 -Os -mmcu=msp430g2553 brushless-firmware/main.c -o brushless-firmware/firmware.elf
...
panel:
	...
	@c++ `sdl2-config --cflags` -I brushless-panel/third-party/imgui brushless-panel/main.cpp brushless-panel/imgui_impl_sdl.cpp brushless-panel/third-party/imgui/imgui*.cpp `sdl2-config --libs` -lGL -o brushless_panel.run
